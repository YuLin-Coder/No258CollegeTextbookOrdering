<template>
	<div class="diy_details_box diy_div_textbook_books">
		<div class="warp">
			<div class="container">
					...
					<div class="view praise_wrap">
						...
						{{ praiseLen }}
							...
							<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/book_purchase/edit','add')" @click="to_form('/book_purchase/edit')" >购买 </button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/book_purchasing/edit','add')" @click="to_form('/book_purchasing/edit')" >采购 </button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/book_shortage_information/edit','add')" @click="to_form('/book_shortage_information/edit')" >缺书 </button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/textbook_books/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/textbook_books/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        vartextbook_books_id = this.obj.textbook_books_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "textbook_books",
          source_field: "textbook_books_id",
          source_id:textbook_books_id
        }, (res) => {
